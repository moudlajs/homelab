...
public static class Program
{
    ...
    /// <summary>
    /// Creates and configures a CommandApp with all services and commands.
    /// Used by both Main() and ShellCommand for re-invocation.
    /// </summary>
    ...
    /// <summary>
    /// Configures all commands. Shared between Main() and ShellCommand.
    /// </summary>
    public static void ConfigureCommands(IConfigurator config)
    {
        ...
        config.AddCommand<ShellCommand>("shell")
            .WithDescription("Interactive shell mode");
